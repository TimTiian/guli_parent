...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("/Users/tatatsuryou/Desktop/guli_parent/service/service_edu" + "/src/main/java");

        gc.setAuthor("test.java");
        gc.setOpen(false);  //生成后是否代开资源管理器
        gc.setFileOverride(false); //重新生成式文件是否覆盖
